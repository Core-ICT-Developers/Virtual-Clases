...
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/wizard-ex-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 17:45:40 GMT -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>Checkout - Wizard Examples | Materio - Bootstrap Material Design Admin Template</title>
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="../../assets/vendor/fonts/materialdesignicons.2.del" />
    <link rel="stylesheet" href="../../assets/vendor/fonts/fontawesome.css" />
    <link rel="stylesheet" href="../../assets/vendor/fonts/flag-icons.css" />
    
    <!-- Menu waves for no-customizer fix -->
    <link rel="stylesheet" href="../../assets/vendor/libs/node-w/node-waves.5.delaye" />
    ...
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="../../assets/vendor/libs/pe/perfect-scrollbar.9.del" />
    <link rel="stylesheet" href="../../assets/vendor/libs/typeahe/typeahead.a.delaye" /> 
    <link rel="stylesheet" href="../../assets/vendor/libs/select2/select2.310.delaye" />
<link rel="stylesheet" href="../../assets/vendor/libs/bs-s/bs-stepper.3bc.delaye" />
<link rel="stylesheet" href="../../assets/vendor/libs/rateyo/rateyo.css" />
<link rel="stylesheet" href="../../assets/vendor/libs/%40form/index.min.320.delaye" />

    <!-- Page CSS -->
    
<link rel="stylesheet" href="../../assets/vendor/css/pag/wizard-ex-checkout.3ca" />

    <!-- Helpers -->
    <script src="../../assets/vendor/js/helpers.js"></script>
    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Template customizer: To hide customizer set displayCustomizer value false in config.js.  -->
    <script src="../../assets/vendor/js/template-customizer.e.delaye"></script>
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo ">
    <a href="../vertical-menu-template/index.html" class="app-brand-link">
...
<span style="color:var(--bs-primary);">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="dashboards-crm.0.delaye" class="menu-link">
            <div data-i18n="CRM">CRM</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-template/index.html" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="layouts-navbar-full.17" class="menu-link">
            <div data-i18n="Navbar full">Navbar full</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="layouts-navbar-full-wit" class="menu-link">
            <div data-i18n="Navbar full + Sidebar">Navbar full + Sidebar</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="https://demos.themeselection.com/materio-bootstrap-html-admin-template/html/horizontal-menu-template" class="menu-link" target="_blank">
            <div data-i18n="Horizontal">Horizontal</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="layouts-without-menu.19" class="menu-link">
        ...
        <li class="menu-item">
          <a href="layouts-fluid.1b.delaye" class="menu-link">
            <div data-i18n="Fluid">Fluid</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="layouts-container.1c.de" class="menu-link">
            <div data-i18n="Container">Container</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="layouts-blank.1d.delaye" class="menu-link">
    ...
    <li class="menu-item">
      <a href="../vertical-menu-templa/app-email.1e.delaye" class="menu-link">
        <i class="menu-icon tf-icons mdi mdi-email-outline"></i>
        <div data-i18n="Email">Email</div>
      </a>
    </li>
    <li class="menu-item">
      <a href="../vertical-menu-templat/app-chat.1f.delaye" class="menu-link">
        <i class="menu-icon tf-icons mdi mdi-message-outline"></i>
        <div data-i18n="Chat">Chat</div>
      </a>
    </li>
    <li class="menu-item">
      <a href="../vertical-menu-tem/app-calendar.20.delaye" class="menu-link">
        <i class="menu-icon tf-icons mdi mdi-calendar-blank-outline"></i>
        <div data-i18n="Calendar">Calendar</div>
      </a>
    </li>
    <li class="menu-item">
      <a href="../vertical-menu-templ/app-kanban.21.delaye" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="app-academy-course.34.d" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="app-logistics-fleet.36" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="app-invoice-list.37.del" class="menu-link">
            <div data-i18n="List">List</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-invoice-preview.38" class="menu-link">
            <div data-i18n="Preview">Preview</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-invoice-edit.39.del" class="menu-link">
            <div data-i18n="Edit">Edit</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-invoice-add.3a.dela" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="app-user-list.3b.delaye" class="menu-link">
            <div data-i18n="List">List</div>
          </a>
        </li>
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="app-access-roles.41.del" class="menu-link">
            <div data-i18n="Roles">Roles</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-access-permission.4" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="pages-profile-user.43.d" class="menu-link">
                <div data-i18n="Profile">Profile</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="pages-profile-teams.44" class="menu-link">
        ...
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            ...
            <li class="menu-item">
              <a href="pages-account-settings-4" class="menu-link">
                <div data-i18n="Billing & Plans">Billing & Plans</div>
              </a>
            </li>
            <li class="menu-item">
        ...
        <li class="menu-item">
          <a href="../vertical-menu-templa/pages-faq.4c.delaye" class="menu-link">
            <div data-i18n="FAQ">FAQ</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="pages-pricing.4d.delaye" class="menu-link">
            <div data-i18n="Pricing">Pricing</div>
          </a>
        </li>
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="pages-misc-error.4e.del" class="menu-link" target="_blank">
            ...
            <li class="menu-item">
              <a href="pages-misc-comingsoon.5" class="menu-link" target="_blank">
            ...
            <li class="menu-item">
              <a href="pages-misc-server-error" class="menu-link" target="_blank">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="auth-login-basic.53.del" class="menu-link" target="_blank">
                <div data-i18n="Basic">Basic</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="auth-login-cover.54.del" class="menu-link" target="_blank">
        ...
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="auth-register-basic.55" class="menu-link" target="_blank">
                <div data-i18n="Basic">Basic</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="auth-register-cover.56" class="menu-link" target="_blank">
                <div data-i18n="Cover">Cover</div>
              </a>
            </li>
            <li class="menu-item">
        ...
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="auth-two-steps-basic.5e" class="menu-link" target="_blank">
                <div data-i18n="Basic">Basic</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="auth-two-steps-cover.5f" class="menu-link" target="_blank">
                <div data-i18n="Cover">Cover</div>
              </a>
            </li>
          </ul>
    ...
    <li class="menu-item active open">
      ...
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="wizard-ex-checkout.60.d" class="menu-link">
            <div data-i18n="Checkout">Checkout</div>
          </a>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-item">
          <a href="wizard-ex-create-deal.6" class="menu-link">
    ...
    <li class="menu-item">
      <a href="modal-examples.63.delay" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="../vertical-menu-temp/cards-basic.64.delaye" class="menu-link">
            <div data-i18n="Basic">Basic</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="cards-advance.65.delaye" class="menu-link">
            <div data-i18n="Advance">Advance</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="cards-statistics.66.del" class="menu-link">
            <div data-i18n="Statistics">Statistics</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="cards-analytics.67.dela" class="menu-link">
            <div data-i18n="Analytics">Analytics</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="cards-gamifications.68" class="menu-link">
            <div data-i18n="Gamifications">Gamifications</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="cards-actions.69.delaye" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="../vertical-menu-tem/ui-accordion.6a.delaye" class="menu-link">
            <div data-i18n="Accordion">Accordion</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-templa/ui-alerts.6b.delaye" class="menu-link">
            <div data-i18n="Alerts">Alerts</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-templa/ui-badges.6c.delaye" class="menu-link">
            <div data-i18n="Badges">Badges</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-templ/ui-buttons.6d.delaye" class="menu-link">
            <div data-i18n="Buttons">Buttons</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-temp/ui-carousel.6e.delaye" class="menu-link">
            <div data-i18n="Carousel">Carousel</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-temp/ui-collapse.6f.delaye" class="menu-link">
            <div data-i18n="Collapse">Collapse</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-tem/ui-dropdowns.70.delaye" class="menu-link">
            <div data-i18n="Dropdowns">Dropdowns</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-templa/ui-footer.71.delaye" class="menu-link">
            <div data-i18n="Footer">Footer</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="ui-list-groups.72.delay" class="menu-link">
            <div data-i18n="List Groups">List groups</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-templa/ui-modals.73.delaye" class="menu-link">
            <div data-i18n="Modals">Modals</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-templa/ui-navbar.74.delaye" class="menu-link">
            <div data-i18n="Navbar">Navbar</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-tem/ui-offcanvas.75.delaye" class="menu-link">
            <div data-i18n="Offcanvas">Offcanvas</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="ui-pagination-breadcrum" class="menu-link">
            <div data-i18n="Pagination & Breadcrumbs">Pagination &amp; Breadcrumbs</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-temp/ui-progress.77.delaye" class="menu-link">
            <div data-i18n="Progress">Progress</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-temp/ui-spinners.78.delaye" class="menu-link">
            <div data-i18n="Spinners">Spinners</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="ui-tabs-pills.79.delaye" class="menu-link">
            <div data-i18n="Tabs & Pills">Tabs &amp; Pills</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-templa/ui-toasts.7a.delaye" class="menu-link">
            <div data-i18n="Toasts">Toasts</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="ui-tooltips-popovers.7b" class="menu-link">
            <div data-i18n="Tooltips & Popovers">Tooltips &amp; popovers</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="ui-typography.7c.delaye" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="extended-ui-avatar.7d.d" class="menu-link">
            <div data-i18n="Avatar">Avatar</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="extended-ui-blockui.7e" class="menu-link">
        ...
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="extended-ui-timeline-ba" class="menu-link">
                <div data-i18n="Basic">Basic</div>
              </a>
            </li>
            <li class="menu-item">
        ...
        <li class="menu-item">
          <a href="extended-ui-tour.87.del" class="menu-link">
            <div data-i18n="Tour">Tour</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="extended-ui-treeview.88" class="menu-link">
            <div data-i18n="Treeview">Treeview</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="extended-ui-misc.89.del" class="menu-link">
    ...
    <!-- Icons -->
    <li class="menu-item">
      <a href="../vertical-menu-templa/icons-mdi.8a.delaye" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="forms-basic-inputs.8b.d" class="menu-link">
            <div data-i18n="Basic Inputs">Basic Inputs</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="forms-input-groups.8c.d" class="menu-link">
            <div data-i18n="Input groups">Input groups</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="forms-custom-options.8d" class="menu-link">
            <div data-i18n="Custom Options">Custom Options</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="forms-editors.8e.delaye" class="menu-link">
            <div data-i18n="Editors">Editors</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="forms-file-upload.8f.de" class="menu-link">
            <div data-i18n="File Upload">File Upload</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="forms-pickers.90.delaye" class="menu-link">
            <div data-i18n="Pickers">Pickers</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="forms-selects.91.delaye" class="menu-link">
            <div data-i18n="Select & Tags">Select &amp; Tags</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="forms-sliders.92.delaye" class="menu-link">
            <div data-i18n="Sliders">Sliders</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="forms-switches.93.delay" class="menu-link">
            <div data-i18n="Switches">Switches</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="../vertical-menu-tem/forms-extras.94.delaye" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="form-layouts-sticky.97" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="form-wizard-numbered.98" class="menu-link">
            <div data-i18n="Numbered">Numbered</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="form-wizard-icons.99.de" class="menu-link">
            <div data-i18n="Icons">Icons</div>
          </a>
        </li>
      </ul>
    ...
    <li class="menu-item">
      <a href="form-validation.9a.dela" class="menu-link">
    ...
    <!-- Tables -->
    <li class="menu-item">
      <a href="../vertical-menu-tem/tables-basic.9b.delaye" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="../vertical-menu-temp/charts-apex.9f.delaye" class="menu-link">
            <div data-i18n="Apex Charts">Apex Charts</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="charts-chartjs.a0.delay" class="menu-link">
    ...
    <li class="menu-item">
      <a href="../vertical-menu-tem/maps-leaflet.a1.delaye" class="menu-link">
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <div class="dropdown-shortcuts-list scrollable-container">
                <div class="row row-bordered overflow-visible g-0">
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="../vertical-menu-tem/app-calendar.20.delaye" class="stretched-link">Calendar</a>
                  ...
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="app-invoice-list.37.del" class="stretched-link">Invoice App</a>
                ...
                <div class="row row-bordered overflow-visible g-0">
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="app-user-list.3b.delaye" class="stretched-link">User App</a>
                  ...
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="app-access-roles.41.del" class="stretched-link">Role Management</a>
                ...
                <div class="row row-bordered overflow-visible g-0">
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="../vertical-menu-template/index.html" class="stretched-link">Dashboard</a>
                ...
                <div class="row row-bordered overflow-visible g-0">
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="pages-help-center-landi" class="stretched-link">Help Center</a>
                  ...
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="modal-examples.63.delay" class="stretched-link">Modals</a>
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
              <li>
                <a class="dropdown-item pb-2 mb-1" href="pages-account-settings-">
              ...
              <li>
                <a class="dropdown-item" href="pages-profile-user.43.d">
              ...
              <li>
                <a class="dropdown-item" href="pages-account-settings-4">
              ...
              <li>
                <a class="dropdown-item" href="pages-help-center-landi">
                  <i class="mdi mdi-lifebuoy me-1 mdi-20px"></i>
                  <span class="align-middle">Help</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="../vertical-menu-templa/pages-faq.4c.delaye">
                  <i class="mdi mdi-help-circle-outline me-1 mdi-20px"></i>
                  <span class="align-middle">FAQ</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="pages-pricing.4d.delaye">
              ...
              <li>
                <a class="dropdown-item" href="auth-login-cover.54.del" target="_blank">
  ...
  <div class="bs-stepper-header m-auto border-0">
      ...
      <button type="button" class="step-trigger">
        <span class="bs-stepper-icon">
          <svg viewBox="0 0 58 54">
            <use xlink:href='https://demos.themeselection.com/materio-bootstrap-html-admin-template/assets/svg/icons/wizard-checkout-cart.svg#wizardCart'></use>
          </svg>
        </span>
      ...
      <button type="button" class="step-trigger">
        <span class="bs-stepper-icon">
          <svg viewBox="0 0 54 54">
            <use xlink:href='https://demos.themeselection.com/materio-bootstrap-html-admin-template/assets/svg/icons/wizard-checkout-address.svg#wizardCheckoutAddress'></use>
          </svg>
        </span>
    ...
    <div class="step" data-target="#checkout-payment">
      <button type="button" class="step-trigger">
        <span class="bs-stepper-icon">
          <svg viewBox="0 0 58 54">
            <use xlink:href='https://demos.themeselection.com/materio-bootstrap-html-admin-template/assets/svg/icons/wizard-checkout-payment.svg#wizardPayment'></use>
          </svg>
        </span>
    ...
    <div class="step" data-target="#checkout-confirmation">
      <button type="button" class="step-trigger">
        <span class="bs-stepper-icon">
          <svg viewBox="0 0 58 54">
            <use xlink:href='https://demos.themeselection.com/materio-bootstrap-html-admin-template/assets/svg/icons/wizard-checkout-confirmation.svg#wizardConfirm'></use>
          </svg>
        </span>
              ...
              <li class="list-group-item p-4">
                <div class="d-flex gap-3">
                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      <div class="col-md-8">
                        <h6 class="me-3"><a href="javascript:void(0)" class="text-body">Google - Google Home - White</a></h6>
                        <div class="text-muted mb-1 d-flex flex-wrap"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-1">Google</a> <span class="badge bg-label-success rounded-pill">In Stock</span></div>
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          ...
                          <div class="my-2 mt-md-4 mb-md-5"><span class="text-primary">$299/</span><span class="text-muted">$359</span></div>
                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="text-muted mb-1 d-flex flex-wrap"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-1">Apple</a> <span class="badge bg-label-success rounded-pill">In Stock</span></div>
                        <div class="read-only-ratings mb-2" data-rateyo-read-only="true"></div>
                        <input type="number" class="form-control form-control-sm w-px-100 mt-4" value="1" min="1" max="5">
                      </div>
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <button type="button" class="btn-close btn-pinned" aria-label="Close"></button>
                          <div class="my-2 mt-md-4 mb-md-5"><span class="text-primary">$899/</span><span class="text-muted">$999</span></div>
                          <button type="button" class="btn btn-sm btn-outline-primary mt-3">Move to wishlist</button>
                        </div>
                      </div>
                    </div>
          ...
          <div class="col-xl-4">
            <div class="border rounded p-3 mb-3">
              ...
              <div class="bg-lighter rounded p-3">
                <p class="fw-medium">Buying gift for a loved one?</p>
      ...
      <div id="checkout-confirmation" class="content">
        <div class="row mb-3">
          <div class="col-12 col-lg-8 offset-lg-2 text-center mb-3">
            ...
            <p><span class="fw-medium"><i class="mdi mdi-av-timer text-heading me-1"></i></span>Time placed: 25/05/2020 13:35pm</p>
          </div>
          ...
          <div class="col-12">
            <ul class="list-group list-group-horizontal-md">
              ...
              <li class="list-group-item flex-fill">
                ...
                <span class="fw-medium">Preferred Method:</span>
                ...
                <div class="d-flex gap-3">
                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <div class="my-2 my-lg-4"><span class="text-primary">$299/</span><span class="text-muted">$359</span></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="d-flex gap-3">
                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <div class="my-2 my-lg-4"><span class="text-primary">$899/</span><span class="text-muted">$999</span></div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-md mb-md-0 mb-3">
                <div class="form-check custom-option custom-option-basic custom-option-label">
                  <label class="form-check-label custom-option-content ps-3" for="customRadioHome">
                    <input name="customRadioTemp" class="form-check-input d-none" type="radio" value="" id="customRadioHome" checked />
                    <span class="custom-option-header">
                      <span class="h6 mb-0"><span class="mdi mdi-home me-2"></span>Home</span>
                    </span>
                    <span class="custom-option-body">
              ...
              <div class="col-md mb-md-0 mb-3">
                <div class="form-check custom-option custom-option-basic custom-option-label">
                  <label class="form-check-label custom-option-content ps-3" for="customRadioOffice">
                    <input name="customRadioTemp" class="form-check-input d-none" type="radio" value="" id="customRadioOffice" />
                    <span class="custom-option-header">
                      <span class="h6 mb-0"><span class="mdi mdi-home me-2"></span>Office</span>
                    </span>
                    <span class="custom-option-body">
...
<!-- / Footer -->
  ...
  <script src="../../assets/vendor/libs/node-/node-waves.b5.delaye"></script>
  <script src="../../assets/vendor/libs/pe/perfect-scrollbar.b6.de"></script>
  <script src="../../assets/vendor/libs/hammer/hammer.js"></script>
  <script src="../../assets/vendor/libs/i18n/i18n.js"></script>
  <script src="../../assets/vendor/libs/typeah/typeahead.b9.delaye"></script>
  <script src="../../assets/vendor/js/menu.js"></script>
  
  <!-- endbuild -->

  <!-- Vendors JS -->
  <script src="../../assets/vendor/libs/select2/select2.314.delaye"></script>
<script src="../../assets/vendor/libs/bs-s/bs-stepper.3bf.delaye"></script>
<script src="../../assets/vendor/libs/rateyo/rateyo.js"></script>
<script src="../../assets/vendor/libs/cleavejs/cleave.js"></script>
<script src="../../assets/vendor/libs/cle/cleave-phone.bd.delaye"></script>
<script src="../../assets/vendor/libs/%40fo/popular.min.323.delaye"></script>
<script src="../../assets/vendor/libs/%40form/index.min.324.delaye"></script>
<script src="../../assets/vendor/libs/%40form/index.min.325.delaye"></script>
...
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/wizard-ex-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 17:45:44 GMT -->
</html>
