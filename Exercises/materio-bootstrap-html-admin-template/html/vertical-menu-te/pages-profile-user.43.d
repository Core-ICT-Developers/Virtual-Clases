...
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/pages-profile-user.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 17:44:08 GMT -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>User Profile - Profile | Materio - Bootstrap Material Design Admin Template</title>
    ...
    <link rel="stylesheet" href="../../assets/vendor/libs/da/datatables.bootstrap5.2">
<link rel="stylesheet" href="../../assets/vendor/libs/da/responsive.bootstrap5.2">
<link rel="stylesheet" href="../../assets/vendor/libs/da/datatables.checkboxes.2">

    <!-- Page CSS -->
    <link rel="stylesheet" href="../../assets/vendor/css/pag/page-profile.38a.delaye" />
...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
      ...
      <li class="nav-item"><a class="nav-link" href="pages-profile-teams.44"><i class='mdi mdi-account-multiple-outline me-1 mdi-20px'></i>Teams</a></li>
      <li class="nav-item"><a class="nav-link" href="pages-profile-projects"><i class='mdi mdi-view-grid-outline me-1 mdi-20px'></i>Projects</a></li>
      <li class="nav-item"><a class="nav-link" href="pages-profile-connectio"><i class='mdi mdi-link me-1 mdi-20px'></i>Connections</a></li>
    </ul>
  </div>
</div>
<!--/ Navbar pills -->
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <ul class="list-unstyled mb-0 mt-3 pt-1">
          ...
          <li class="d-flex align-items-center mb-3"><i class="mdi mdi-account-outline mdi-24px"></i><span class="fw-medium mx-2">Connections:</span> <span>897</span></li>
          <li class="d-flex align-items-center"><i class="mdi mdi-view-grid-outline mdi-24px"></i><span class="fw-medium mx-2">Projects Compiled:</span> <span>146</span></li>
        </ul>
      </div>
    </div>
    <!--/ Profile Overview -->
        ...
        <ul class="timeline card-timeline mb-0">
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex">
                <a href="javascript:void(0)" class="me-3">
                  <img src="../../assets/img/icons/misc/pdf.png" alt="PDF image" width="20" class="me-1">
          ...
          <li class="timeline-item timeline-item-transparent">
            ...
            <div class="timeline-event">
              ...
              <p class="text-muted mb-2">Sent by Mollie Dixon <img src="../../assets/img/avatars/4.png" class="rounded-circle me-3" alt="avatar" height="24" width="24"></p>
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="../../assets/img/icons/brand/react-label.38e.delaye" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="../../assets/img/icons/bran/support-label.38f.delay" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="../../assets/img/icons/brand/figma-label.390.delaye" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="../../assets/img/icons/bran/twitter-label.392.delay" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-w">
...
<!-- / Footer -->
  ...
  <!-- Vendors JS -->
  <script src="../../assets/vendor/libs/da/datatables-bootstrap5.2"></script>
...
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/pages-profile-user.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 17:44:14 GMT -->
</html>
