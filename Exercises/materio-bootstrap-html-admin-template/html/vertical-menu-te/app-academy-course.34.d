...
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/app-academy-course.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 17:43:38 GMT -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>My Courses - Academy | Materio - Bootstrap Material Design Admin Template</title>
...
<link rel="stylesheet" href="../../assets/vendor/css/page/app-academy.358.delaye" />
  ...
  <div class="card p-0 mb-4">
    <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-4">
      <div class="app-academy-md-25 card-body py-0">
        <img src="../../assets/img/illustration/bulb-light.359.delaye" class="img-fluid app-academy-img-height scaleX-n1-rtl" alt="Bulb in hand" data-app-light-img="illustrations/bulb-light.png" data-app-dark-img="illustrations/bulb-dark.png" height="90" />
      </div>
      ...
      <div class="app-academy-md-25 d-flex align-items-end justify-content-end">
        <img src="../../assets/img/illustrati/pencil-rocket.35a.delay" alt="pencil rocket" height="188" class="scaleX-n1-rtl" />
      </div>
    </div>
  </div>
    ...
    <div class="card-body">
      <div class="row gy-4 mb-4">
        <div class="col-sm-6 col-lg-4">
          <div class="card shadow-none border p-2 h-100">
            <div class="rounded-2 text-center mb-3">
              <a href="app-academy-course-deta"><img class="img-fluid" src="../../assets/img/pages/app-academy-tutor-1.35b.dela" alt="tutor image 1"></a>
            </div>
            <div class="card-body p-3 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                  4.4 <span class="text-warning"><i class="mdi mdi-star me-1"></i></span><span class="fw-normal">(1.23k)</span>
                </p>
              </div>
              <a href="app-academy-course-deta" class="h5">Basics of Angular</a>
              ...
              <div class="d-flex flex-column flex-md-row gap-3 text-nowrap flex-wrap flex-md-nowrap  flex-lg-wrap flex-xxl-nowrap">
                <a class="w-100 btn btn-outline-secondary d-flex align-items-center" href="app-academy-course-deta">
                  <i class="mdi mdi-sync align-middle me-1"></i><span>Start Over</span>
                </a>
                <a class="w-100 btn btn-outline-primary d-flex align-items-center" href="app-academy-course-deta">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card shadow-none border p-2 h-100">
            <div class="rounded-2 text-center mb-3">
              <a href="app-academy-course-deta"><img class="img-fluid" src="../../assets/img/pages/app-academy-tutor-2.35c.dela" alt="tutor image 2"></a>
            </div>
            <div class="card-body p-3 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-3 pe-xl-3 pe-xxl-0">
                ...
                <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                  4.2 <span class="text-warning"><i class="mdi mdi-star me-1"></i></span><span class="fw-noraml"> (424)</span>
                </p>
              </div>
              <a class="h5" href="app-academy-course-deta">Figma & More</a>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card shadow-none border p-2 h-100">
            <div class="rounded-2 text-center mb-3">
              <a href="app-academy-course-deta"><img class="img-fluid" src="../../assets/img/pages/app-academy-tutor-3.35d.dela" alt="tutor image 3"></a>
            </div>
            <div class="card-body p-3 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <span class="badge rounded-pill bg-label-success">SEO</span>
                <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                  5 <span class="text-warning"><i class="mdi mdi-star me-1"></i></span><span class="fw-noraml"> (12)</span>
                </p>
              </div>
              <a class="h5" href="app-academy-course-deta">Keyword Research</a>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card shadow-none border p-2 h-100">
            <div class="rounded-2 text-center mb-3">
              <a href="app-academy-course-deta"><img class="img-fluid" src="../../assets/img/pages/app-academy-tutor-4.35e.dela" alt="tutor image 4"></a>
            </div>
            <div class="card-body p-3 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <span class="badge rounded-pill bg-label-info">Music</span>
                <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                  3.8 <span class="text-warning"><i class="mdi mdi-star me-1"></i></span><span class="fw-noraml"> (634)</span>
                </p>
              </div>
              <a class="h5" href="app-academy-course-deta">Basics to Advanced</a>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card shadow-none border p-2 h-100">
            <div class="rounded-2 text-center mb-3">
              <a href="app-academy-course-deta"><img class="img-fluid" src="../../assets/img/pages/app-academy-tutor-5.35f.dela" alt="tutor image 5"></a>
            </div>
            <div class="card-body p-3 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <span class="badge rounded-pill bg-label-warning">Painting</span>
                <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                  4.7 <span class="text-warning"><i class="mdi mdi-star me-1"></i></span><span class="fw-noraml"> (34)</span>
                </p>
              </div>
              <a class="h5" href="app-academy-course-deta">Art & Drawing</a>
              <p class="mt-2">Easy-to-follow video & guides show you how to draw animals, people & more.</p>
              <p class="d-flex align-items-center text-success"><i class="mdi mdi-check me-2"></i>Completed</p>
              <div class="progress rounded-pill mb-4" style="height: 8px">
                <div class="progress-bar w-100" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <a class="w-100 btn btn-outline-primary" href="app-academy-course-deta"><i class="mdi mdi-sync me-2"></i>Start Over</a>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4">
          <div class="card shadow-none border p-2 h-100">
            <div class="rounded-2 text-center mb-3">
              <a href="app-academy-course-deta"><img class="img-fluid" src="../../assets/img/pages/app-academy-tutor-6.360.dela" alt="tutor image 6"></a>
            </div>
            <div class="card-body p-3 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <span class="badge rounded-pill bg-label-danger">UI/UX</span>
                <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                  3.6 <span class="text-warning"><i class="mdi mdi-star me-1"></i></span><span class="fw-noraml"> (2.5k)</span>
                </p>
              </div>
              <a class="h5" href="app-academy-course-deta">Basics Fundamentals</a>
      ...
      <div class="card shadow-none bg-label-primary h-100">
        <div class="card-body d-flex justify-content-between flex-wrap-reverse">
          ...
          <div class="w-100 app-academy-sm-40 d-flex justify-content-center justify-content-sm-end h-px-150 mb-3 mb-sm-0">
            <img class="img-fluid scaleX-n1-rtl" src="../../assets/img/illustrati/boy-app-academy.361.del" alt="boy illustration" />
          </div>
        </div>
      </div>
    </div>
    <div class="col-lg-6">
      <div class="card shadow-none bg-label-danger h-100">
        <div class="card-body d-flex justify-content-between flex-wrap-reverse">
          ...
          <div class="w-100 app-academy-sm-40 d-flex justify-content-center justify-content-sm-end h-px-150 mb-3 mb-sm-0">
            <img class="img-fluid scaleX-n1-rtl" src="../../assets/img/illustrati/girl-app-academy.362.de" alt="girl illustration" />
          </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/app-academy-course.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 17:43:45 GMT -->
</html>
